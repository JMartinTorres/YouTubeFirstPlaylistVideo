$( document ).ready(function() {
	...
	// HoverIn and focusIn events: send message to background script to add the context menu options
	...
	// HoverOut and focusOut events: send message to background script to remove the added context menu options
